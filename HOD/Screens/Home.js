      ...
      >
        ...
        {changes.length > 0 && (
          <View
            ...
            accessibilityLabel="Vigtige ændringer"
        ...
        <View style={Styles.quickRow} accessibilityRole="menu">
          ...
          <Pressable
            ...
            accessibilityHint="Viser billeder og videoer"
          >
          ...
          <Pressable
            ...
            accessibilityHint="Viser kortet over pladsen"
          >
        ...
        <View style={Styles.helpCard}>
          ...
          <View style={Styles.contactList} accessibilityLabel="Kontakt pædagoger">
            {CONTACTS.map((c, i) => (
              <Pressable
                key={i}
